...
def run():
    ...
    """
    inputs = {
        'topic': 'Atualizações e novas possibilidades do crewAI 0.70. Explique em tópicos as melhorias, traga possibilidades novas de negócio, e diga que, por aqui, já estamos testando e implementando novas ideias.'
    }
